...
const messages: Record<UiLanguage, Messages> = {
  en: {
    ...
    home: {
      ...
      ttsVolcengine: "Volcengine Doubao TTS",
      ttsAzure: "Microsoft Azure TTS",
      ttsProviderHelp: "Volcengine/Azure use cloud HTTP TTS. Configure credentials in Settings first.",
      ...
      batchDeleteTitle: "Delete selected tasks?",
      batchDeleteDescription:
        "This permanently deletes the selected tasks, their session folders under workfolder/, logs, and local uploads. Running tasks are skipped.",
      batchDeleteConfirm: "Delete selected",
      batchDeleteSummary:
        "Deleted {deleted}. Skipped running {skipped}. Missing {missing}. Failed {failed}.",
      batchDeleteError: "Failed to delete selected tasks",
      batchDeleteNone: "No deletable tasks selected.",
      batchRetry: "Retry selected",
      batchRetrying: "Retrying",
      batchRetryTitle: "Retry selected failed tasks?",
      batchRetryDescription:
        "Failed tasks will resume from the failed stage and reuse succeeded stage caches. Non-failed tasks are skipped.",
      batchRetryConfirm: "Retry selected",
      batchRetrySummary:
        "Resumed {resumed}. Skipped {skipped}. Missing {missing}. Failed {failed}.",
      batchRetryError: "Failed to retry selected tasks",
      batchRetryNone: "No tasks selected.",
    ...
    task: {
      ...
      ttsVoxcpm: "VoxCPM",
      ttsVolcengine: "Volcengine Doubao",
    ...
    settings: {
      ...
      outputDirHelp: "When set, each completed video is copied here as title__taskId.mp4, with a matching Chinese .srt subtitle.",
      ...
      volcengineSaveSection: "Volcengine TTS settings",
      volcengineSection: "Volcengine Doubao TTS",
      volcengineHelp:
        "Uses the unidirectional streaming HTTP API. Prefer API key auth; legacy App ID + Access Key is also supported.",
      volcengineAppId: "App ID",
      volcengineAccessKey: "Access Key",
      volcengineApiKey: "API Key",
      volcengineApiKeyPlaceholder: "Leave blank to keep existing key",
      volcengineResourceId: "Resource ID",
      volcengineSpeaker: "Speaker / voice ID",
      volcengineEndpoint: "Endpoint",
      volcengineSampleRate: "Sample rate",
      volcengineSpeechRate: "Speech rate (-50 to 100)",
      volcengineConcurrency: "TTS concurrency",
      volcengineConcurrencyHelp: "Parallel Volcengine TTS requests. Keep within your account QPS/concurrency quota.",
      volcengineUid: "User ID",
      azureSaveSection: "Azure TTS settings",
      azureSection: "Microsoft Azure Speech TTS",
      azureHelp:
        "Uses the Azure Speech REST text-to-speech API. Provide a Speech resource subscription key and region (or a custom endpoint).",
      azureSubscriptionKey: "Subscription key",
      azureSubscriptionKeyPlaceholder: "Leave blank to keep existing key",
      azureRegion: "Region",
      ...
      azureConcurrencyHelp: "Parallel Azure TTS requests. Keep within your Speech resource quota.",
  ...
  zh: {
    ...
    home: {
      ...
      ttsVolcengine: "火山引擎豆包语音合成",
      ttsAzure: "微软 Azure 语音合成",
      ttsProviderHelp: "火山引擎 / Azure 使用云端 HTTP TTS。请先在设置中配置密钥与音色。",
      taskHistory: "任务历史",
      ...
      batchDeleteDescription:
        "将永久删除所选任务及其 workfolder/ 会话目录、日志和本地上传文件。正在运行的任务会被跳过。",
      ...
      batchRetryDescription:
        "失败任务将从失败阶段继续执行，并复用已成功阶段的缓存。非失败状态的任务会被跳过。",
    ...
    settings: {
      ...
      outputDirHelp: "填写后，任务成功时会把成品视频和同名中文字幕（.srt）复制到该目录，例如 标题__任务ID.mp4 / .srt。",
      ...
      volcengineSaveSection: "火山引擎 TTS 设置",
      volcengineSection: "火山引擎豆包语音合成",
      volcengineHelp:
        "对接单向流式 HTTP TTS。优先使用 API Key；也支持旧版 App ID + Access Key。",
      volcengineAppId: "App ID",
      volcengineAccessKey: "Access Key",
      volcengineApiKey: "API Key",
      volcengineApiKeyPlaceholder: "留空则保留现有 key",
      volcengineResourceId: "Resource ID",
      volcengineSpeaker: "音色 / Speaker ID",
      volcengineEndpoint: "接口地址",
      volcengineSampleRate: "采样率",
      volcengineSpeechRate: "语速（-50 到 100）",
      volcengineConcurrency: "TTS 并发数",
      volcengineConcurrencyHelp: "豆包语音合成并行请求数。请按账号 QPS/并发额度调整。",
      volcengineUid: "用户 ID",
      azureSaveSection: "Azure TTS 设置",
      azureSection: "微软 Azure 语音合成",
      azureHelp:
        "对接 Azure Speech REST TTS。请填写 Speech 资源的订阅密钥与区域（或自定义 endpoint）。",
      azureSubscriptionKey: "订阅密钥",
      azureSubscriptionKeyPlaceholder: "留空则保留现有 key",
      azureRegion: "区域",
      azureVoice: "音色名称",
      azureLocale: "语言区域",
      ...
      azureConcurrencyHelp: "Azure TTS 并行请求数。请按 Speech 资源额度调整。",
