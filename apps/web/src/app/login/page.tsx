...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center page-bg px-4 py-8">
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={submit} className="space-y-4">
              ...
              {error ? (
                <p className="rounded-lg border border-red-500/30 bg-red-950/40 px-3 py-2 text-sm text-red-300" role="alert">
                  {error}
                </p>
              ) : null}
